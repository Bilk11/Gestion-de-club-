...
class CategorieDAO {
    ...
    public function update(Categorie $categorie) {
        try {
            $stmt = $this->connexion->pdo->prepare("UPDATE categories SET nom = ?, code_raccourci = ? WHERE id_categorie = ?");
    ...
    public function delete(Categorie $categorie) {
        try {
            $stmt = $this->connexion->pdo->prepare("DELETE FROM categories WHERE id_categorie = ?");
    ...
    public function getById($id) {
        try {
            $stmt = $this->connexion->pdo->prepare("SELECT * FROM categories WHERE id_categorie = ?");
            $stmt->execute([$id]);
