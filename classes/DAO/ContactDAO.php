...
class ContactDAO {
    ...
    public function update(Contact $contact) {
        try {
            $stmt = $this->connexion->pdo->prepare("UPDATE contacts SET nom = ?, prenom = ?, email = ?, numero_tel = ? WHERE id_contact = ?");
    ...
    public function delete(Contact $contact) {
        try {
            $stmt = $this->connexion->pdo->prepare("DELETE FROM contacts WHERE id_contact = ?");
    ...
    public function getById($id) {
        try {
            $stmt = $this->connexion->pdo->prepare("SELECT * FROM contacts WHERE id_contact = ?");
            $stmt->execute([$id]);
